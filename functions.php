...
if ( ! function_exists( 'wedding_setup' ) ) :
	...
	function wedding_setup() {
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'wedding' ),
		) );
 ...
 */
class wedding extends Walker_Nav_Menu
{
...
function RadTheme_enqueue_styles() {
  ...
  function RadTheme_enqueue_scripts() {
    wp_enqueue_script( 'bootstrap', get_template_directory_uri() . '/assets/js/vendor/bootstrap.bundle.min.js', array( 'jquery' ) );
  }
